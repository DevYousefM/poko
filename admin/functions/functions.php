...
if (isset($_POST['upload_game'])) {
    ...
    $sql = "INSERT INTO `zon_games`(`game_slug`, `game_name`, `game_description`, `game_image_url`, `game_url`, `game_published`, `game_category`, `game_status`, `game_played`, `game_banner_url`, `is_featured`, `game_card_size`) VALUES ('$game_slug','$game_name','$game_desc','$game_image_url','$game_frame_url', '$game_status', '$game_category', 0, 0,'$game_banner_url', 0, '')";
...
if (isset($_POST['update_game'])) {
    ...
    $sql = "UPDATE `zon_games` SET `game_slug`='$game_slug', `game_name`='$game_name', `game_description`='$game_desc', `game_image_url`='$game_image_url', `game_url`='$game_frame_url', `game_published`='$game_status', `game_category`='$game_category', `game_banner_url`='$game_banner_url' WHERE id=$game_id";
...
if (isset($_POST['add_category'])) {
    ...
    if (mysqli_query($con, "insert into zon_category (`name`, `slug`, `description`) values ('$category_name' , '$category_slug' , '$category_description') ")) {
...
if (isset($_POST['update_category'])) {
    ...
    if (mysqli_query($con, "update zon_category set `description`='$category_description', `name`='$category_name', `slug`='$category_slug' where id=$category_id")) {
        @header("location: ../categories.php");
    }
}
